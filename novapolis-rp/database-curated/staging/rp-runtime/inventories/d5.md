...
update: Runtime-Bedarfsnotiz fuehrt D5 jetzt getrennt vom neuen Draisine-Traeger; D5 bleibt fuer Tunnelbedarf und den kleinen Turn-7/8-Satz zustaendig.
...
- Der gebundene Prototypbestand der Draisine wird ab jetzt in `inventories/draisine-transportmodul.md` getrennt gefuehrt statt weiter implizit in der D5-Bedarfsnotiz mitzuschwingen.
...
- Der eigentliche Projektbedarf von Nordlinie 01 liegt ab jetzt zusaetzlich in `inventories/nordlinie-01.md`, damit `inventories/d5.md` nicht gleichzeitig Ortsbestand, Altverbrauch und gesamte Projektbedarfskalkulation tragen muss.
...
- evidence_chain:
  ...
  - `state/nordlinie-01.md`, Named Problem Clusters / `Schottertasche Nordkante`
...
- Draisine-Eigenbestand, kleiner Werkstattverbrauchsrahmen und spaetere echte Draisine-Abgaenge laufen ab jetzt ueber `inventories/draisine-transportmodul.md`, nicht ueber diese D5-Bedarfsnotiz.
- Nordlinie-Reparaturbedarf und Cluster-Materialschnitt laufen ab jetzt ueber `inventories/nordlinie-01.md`; dieses D5-Inventar bleibt der ortsgebundene Quell- und Bedarfstraeger.
