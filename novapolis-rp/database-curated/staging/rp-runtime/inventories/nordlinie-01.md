...
update: Nordlinie 01 fuehrt jetzt einen eigenen Runtime-Inventartraeger fuer belegten Reparaturbedarf, harte Blocker und die vom kleinen Turn-7/8-Satz getrennten Folgebedarfe.
...
- Dieser Traeger fuehrt den Nordlinie-Bedarf deshalb ab jetzt getrennt von `inventories/d5.md` und `inventories/draisine-transportmodul.md`.
