...
- Der Trennschnitt ist absichtlich hart: gebundener Prototypbestand hier, D5-/Nordlinie-Tunnelbedarf weiter in `../../locations/d5/inventory.md` und den Projekt-/State-Traegern.
...
- `../../locations/d5/state.md`
- `../../projects/nordlinie-01/state.md`
