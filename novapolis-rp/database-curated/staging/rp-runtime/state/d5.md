...
update: D5 fuehrt den Nordlinie-Stand jetzt mit eigenem Runtime-Traeger fuer die Draisine; gebundener Prototypbestand und Tunnelbedarf bleiben getrennt.
...
- drivers:
  ...
  - Der neue Runtime-Traeger `inventories/draisine-transportmodul.md` trennt ab jetzt gebundenen Prototypbestand sauber vom Nordlinie-/Tunnelbedarf.
- blockers:
