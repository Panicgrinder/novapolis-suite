...
Vergleich: F:/VS Code Workspace/Main/novapolis-rp/database-raw/99-exports/chat-export-complete.txt  <->  F:/VS Code Workspace/Main/novapolis-rp/database-raw/99-exports/chat-export (1).txt

- Zeilen A: 21645
- Zeilen B: 10819
- Jaccard-Ähnlichkeit (Zeilenmenge): 0.939
- Diff: +394  -9315

## Diff (A->B) - Auszug
--- F:/VS Code Workspace/Main/novapolis-rp/database-raw/99-exports/chat-export-complete.txt
+++ F:/VS Code Workspace/Main/novapolis-rp/database-raw/99-exports/chat-export (1).txt
@@ -904,7 +904,105 @@
 -----
