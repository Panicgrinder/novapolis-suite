...
title: 24x1h Log-Template (Novapolis)
category: project
slug: 24x1h-log-template-novapolis
version: "0.1"
status: planned
last_updated: "2026-02-22"
owners: [novapolis]
tags: [rp, template, 24x1h, logs]
relatedSlugs: [missionslog-novapolis, tick-regeln-simulation, sim-state-schema]
---

<!-- markdownlint-disable MD025 -->

24x1h Log-Template (Novapolis)
==============================

Zweck
-----
Diese Vorlage setzt den globalen 24x1h-Standard aus `00-admin` fraktionslokal um.
Sie ist neutral strukturiert; Inhalte werden pro Tick aus Novapolis-Sicht befüllt.
...
- Fraktions-Missionslog: [Missionslog-Novapolis](./Missionslog-Novapolis.md)
