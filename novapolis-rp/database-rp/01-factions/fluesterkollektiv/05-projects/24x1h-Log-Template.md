...
title: 24x1h Log-Template (Flüsterkollektiv)
category: project
slug: 24x1h-log-template-fluesterkollektiv
version: "0.1"
status: planned
last_updated: "2026-02-22"
owners: [fluesterkollektiv]
tags: [rp, template, 24x1h, logs]
relatedSlugs: [missionslog-fluesterkollektiv, tick-regeln-simulation, sim-state-schema]
---

<!-- markdownlint-disable MD025 -->

24x1h Log-Template (Flüsterkollektiv)
=====================================

Zweck
-----
Diese Vorlage setzt den globalen 24x1h-Standard aus `00-admin` fraktionslokal um.
Sie ist neutral strukturiert; Inhalte werden pro Tick aus Flüsterkollektiv-Sicht befüllt.
...
- Fraktions-Missionslog: [Missionslog-Fluesterkollektiv](./Missionslog-Fluesterkollektiv.md)
