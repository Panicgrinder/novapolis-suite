...
- Belegte Austauschklassen im Aufbaupfad sind `Energie`, `technische Reparaturen`, `Kommunikationszugang` gegen `Nahrungsmittel (Grundbedarf)`, `Filter` und `Grundbedarfsgueter`.
...
- 2026-03-31 [FACT?] Das diplomatische Lagebild fuehrt erste Handelskontakte ueber Karawane `H-47 (Senn Daru)` in `C6`; belegt sind die Austauschklassen `Energie`, `technische Reparaturen`, `Kommunikationszugang` sowie `Nahrungsmittel (Grundbedarf)`, `Filter`, `Grundbedarfsgueter`. Quelle: `../../../database-raw/99-exports/RAW-canvas-2025-10-16T08-07-00-000Z.txt`, [G7](../03-locations/G7.md), [Handel-Diplomatie-Haendlergilde](../06-handel-diplomatie/Handel-Diplomatie-Haendlergilde.md).
