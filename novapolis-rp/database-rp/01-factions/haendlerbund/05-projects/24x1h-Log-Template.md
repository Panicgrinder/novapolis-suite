...
title: 24x1h Log-Template (Händlerbund)
category: project
slug: 24x1h-log-template-haendlerbund
version: "0.1"
status: planned
last_updated: "2026-02-22"
owners: [haendlerbund]
tags: [rp, template, 24x1h, logs]
relatedSlugs: [missionslog-haendlerbund, tick-regeln-simulation, sim-state-schema]
---

<!-- markdownlint-disable MD025 -->

24x1h Log-Template (Händlerbund)
================================

Zweck
-----
Diese Vorlage setzt den globalen 24x1h-Standard aus `00-admin` fraktionslokal um.
Sie ist neutral strukturiert; Inhalte werden pro Tick aus Händlerbund-Sicht befüllt.
...
- Fraktions-Missionslog: [Missionslog-Haendlerbund](./Missionslog-Haendlerbund.md)
