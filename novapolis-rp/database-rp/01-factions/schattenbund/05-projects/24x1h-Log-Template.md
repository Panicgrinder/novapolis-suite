...
title: 24x1h Log-Template (Schattenbund)
category: project
slug: 24x1h-log-template-schattenbund
version: "0.1"
status: planned
last_updated: "2026-02-22"
owners: [schattenbund]
tags: [rp, template, 24x1h, logs]
relatedSlugs: [missionslog-schattenbund, tick-regeln-simulation, sim-state-schema]
---

<!-- markdownlint-disable MD025 -->

24x1h Log-Template (Schattenbund)
=================================

Zweck
-----
Diese Vorlage setzt den globalen 24x1h-Standard aus `00-admin` fraktionslokal um.
Sie ist neutral strukturiert; Inhalte werden pro Tick aus Schattenbund-Sicht befüllt.
...
- Fraktions-Missionslog: [Missionslog-Schattenbund](./Missionslog-Schattenbund.md)
