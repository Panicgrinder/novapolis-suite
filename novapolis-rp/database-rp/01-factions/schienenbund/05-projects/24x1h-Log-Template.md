...
title: 24x1h Log-Template (Schienenbund)
category: project
slug: 24x1h-log-template-schienenbund
version: "0.1"
status: planned
last_updated: "2026-02-22"
owners: [schienenbund]
tags: [rp, template, 24x1h, logs]
relatedSlugs: [missionslog-schienenbund, tick-regeln-simulation, sim-state-schema]
---

<!-- markdownlint-disable MD025 -->

24x1h Log-Template (Schienenbund)
=================================

Zweck
-----
Diese Vorlage setzt den globalen 24x1h-Standard aus `00-admin` fraktionslokal um.
Sie ist neutral strukturiert; Inhalte werden pro Tick aus Schienenbund-Sicht befüllt.
...
- Fraktions-Missionslog: [Missionslog-Schienenbund](./Missionslog-Schienenbund.md)
