...
Copilot-Instructions Erweiterungs-ToDos
=======================================
...
----------------------
- Weiter Inkonsistenzen bei Frontmatter/TZ → chaotische Chronologie.
- Fehlende Typprüfungs-Task → vergessene Typechecks.
- Unklarer Scope → Erwartungslücken bei Apply-Patch / Inline.
