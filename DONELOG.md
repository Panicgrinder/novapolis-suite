...
update: "PR_DESCRIPTION.md auf PR #4 (docs(rp) Batch C) aktualisiert; Receipt/Checks nachgezogen (DONELOG+PR_DESCRIPTION)."
checks: npx --yes markdownlint-cli2 --config .markdownlint-cli2.jsonc DONELOG.md PR_DESCRIPTION.md PASS (2026-02-17 07:18); & .\\.venv\\Scripts\\python.exe scripts\\check_frontmatter.py DONELOG.md PR_DESCRIPTION.md PASS (2026-02-17 07:18); npm --prefix novapolis-rp/coding/tools/validators run validate PASS (2026-02-17 07:18)
---
Kurzueberblick
--------------
