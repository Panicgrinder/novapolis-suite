...
update: Agent-Open-Count nach Analyse-basiertem TTS-Mini-Service-Backlog im Agent-Board aktualisiert.
...
- Agent-Module: `docs/todo.agent-board.md` — Backend (FastAPI/Ollama), Tests/Typing, Scripts (offen: 8)
