...
update: Das Agent-Board fuehrt weiter genau einen offenen RP->Training-Punkt; die Rueckkopplung ueber Eval-/Export-Pfade ist jetzt task- und testseitig verdrahtet, offen bleibt nur noch der harte Gate-Block vor LoRA.
...
- [x] [Als naechstes] Den `gm_session`-Hard-Fail bei nicht erreichbarer lokaler Modellruntime diagnostisch besser einhegen.
  ...
  - Akzeptanzkriterien:
    ...
    2) der Hard-Fail bleibt produktseitig erhalten, wird aber schneller und eindeutiger berichtet,
