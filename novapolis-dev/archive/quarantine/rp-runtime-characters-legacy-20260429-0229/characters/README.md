...
update: Legacy-Typordner nach entity-centric Runtime-Migration; aktive Daten liegen unter `../entities/characters`.
...
Legacy Runtime Folder - characters
==================================
...
- state: migriert
- active_target: `../entities/characters`
